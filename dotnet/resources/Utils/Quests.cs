...
namespace UnitedRP.Utils
{
    ...
    class QuestsManager : Script
    {
        ...
        public static void OptimizeData(Player player, Settings.Utils.QuestDATABASE que)
        {
            try
            {
        ...
        public static UnitedRP.Settings.Utils.QuestDATABASE OptimizePlayer(Player player)
        {
            try
            {
                ...
                return new UnitedRP.Settings.Utils.QuestDATABASE(Week, quests);
            }
        ...
        public static void OptimizeQuests()
        {
            try
            {
                foreach (Player player in NAPI.Pools.GetAllPlayers())
                {
                    ...
                    Main.Players[player].Quests = new UnitedRP.Settings.Utils.QuestDATABASE(Week, quests);
