...
namespace UnitedRP.Settings
{
    public enum ItemType
    {
        ...
        /* Alco */
        MartiniAsti = 219, // Martini Asti
        Sambuca = 220,     // Sambuca
        VodkaWLimon = 221, // Водка с лимоном
        VodkaWBrusk = 222, // Водка с брусникой
        RussianStan = 223, // Русский стандарт
        KoniakDjiva = 224, // Коньяк Дживан
        KoniakApara = 225, // Коньяк Арарат
        PivoRazliva = 226, // Пиво разливное
        PivoButiloc = 227, // Пиво бутылочное
        Bong = 228,        // Бонг

        Repair = 250,      // Рем комплект	

        Bint = 251,        // Бинт
        Aptechka = 252,    // Аптечка
        Tabletka = 253,    // Таблечка
        Adrenalin = 254,   // Адреналин

        Kokos = 255,       // Листья коки
