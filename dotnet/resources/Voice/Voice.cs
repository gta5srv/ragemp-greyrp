...
namespace UnitedRP.Voice
{
    public class Voice : Script
    {
        ...
        public static void PlayerQuit(Player player, string reson)
        {
            try
            {
                ...
                if (playerPhoneMeta.Target != null)
                {
                    ...
                    UnitedRP.Core.BasicSync.DetachObject(target);

                    UnitedRP.Trigger.PlayerEvent(target, "voice.phoneStop");
        ...
        public void voiceDebugReload(Player player)
        {
            ...
            UnitedRP.Trigger.PlayerEvent(player, "v_reload");
        }
        ...
        public void voiceDebug2Reload(Player player)
        {
            ...
            UnitedRP.Trigger.PlayerEvent(player, "v_reload2");
        }
        ...
        public void voiceDebug3Reload(Player player)
        {
            ...
            UnitedRP.Trigger.PlayerEvent(player, "v_reload3");
        }
        ...
        public static void PhoneCallCommand(Player player, Player target)
        {
            try
            {
                ...
                if (target != null && Main.Players.ContainsKey(target))
                {
                    ...
                    UnitedRP.Core.BasicSync.AttachObjectToPlayer(player, NAPI.Util.GetHashKey("prop_amb_phone"), 6286, new Vector3(0.06, 0.01, -0.02), new Vector3(80, -10, 110));
                    ...
                    NAPI.Task.Run(() => {
                        try
                        {
                            ...
                            UnitedRP.Core.BasicSync.DetachObject(player);
        ...
        public static void PhoneCallAcceptCommand(Player player)
        {
            try
            {
                ...
                UnitedRP.Trigger.PlayerEvent(player, "voice.phoneCall", target, 1);
                UnitedRP.Trigger.PlayerEvent(target, "voice.phoneCall", player, 1);
        ...
        public static void PhoneHCommand(Player player)
        {
            try
            {
                ...
                UnitedRP.Trigger.PlayerEvent(player, "voice.phoneStop");
                UnitedRP.Trigger.PlayerEvent(target, "voice.phoneStop");
        ...
        public void SetMicrophoneKey(Player player, int microphoneKey)
        {
            try
            {
                ...
                UnitedRP.Trigger.PlayerEvent(player, "voice.changeMicrophoneActivationKey", microphoneKey);
