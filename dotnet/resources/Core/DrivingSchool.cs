...
namespace UnitedRP.Core
{
    class DrivingSchool : Script
    {
        ...
        private static Vector3 enterSchool = new Vector3(-915.0799, -2038.6448, 8.284775);
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Сдача прав"), new Vector3(enterSchool.X, enterSchool.Y, enterSchool.Z + 1), 5f, 0.3f, 0, new Color(255, 255, 255));
