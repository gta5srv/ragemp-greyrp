...
using UnitedRP.Core.Character;

namespace UnitedRP.Core
{
    class nInventory : Script
    {
        public static Dictionary<int, string> ItemsNames = new Dictionary<int, string>
        {
            ...
            { 10507, "Семена моркови" },
            { 10508, "Семена пшеницы" },
            { 10509, "Семена клевера" },
			
			{777, "Виноград" },
            {778, "Заказ для доставки" },
        ...
        public static Dictionary<ItemType, uint> ItemModels = new Dictionary<ItemType, uint>()
        {
			...
			{ ItemType.Vinograd, NAPI.Util.GetHashKey("prop_food_cb_burg02") },
            { ItemType.Delivery, NAPI.Util.GetHashKey("prop_food_cb_burg02") },
            ...
            { ItemType.Chyka, NAPI.Util.GetHashKey("prop_starfish_01") },
			            ...
			            /*Alco */
            { ItemType.MartiniAsti, NAPI.Util.GetHashKey("prop_tequila_bottle") },
			{ ItemType.Sambuca, NAPI.Util.GetHashKey("prop_bottle_brandy") },
			{ ItemType.VodkaWLimon, NAPI.Util.GetHashKey("prop_vodka_bottle") },
			{ ItemType.VodkaWBrusk, NAPI.Util.GetHashKey("prop_vodka_bottle") },
			{ ItemType.RussianStan, NAPI.Util.GetHashKey("prop_vodka_bottle") },
			{ ItemType.KoniakDjiva, NAPI.Util.GetHashKey("prop_whiskey_bottle") },
			{ ItemType.KoniakApara, NAPI.Util.GetHashKey("prop_whiskey_bottle") },
			{ ItemType.PivoRazliva, NAPI.Util.GetHashKey("prop_cs_beer_bot_40oz") },
			{ ItemType.PivoButiloc, NAPI.Util.GetHashKey("prop_amb_beer_bottle") },
            { ItemType.Bong, NAPI.Util.GetHashKey("prop_bong_01") },
			
			{ ItemType.Repair, NAPI.Util.GetHashKey("prop_tool_box_01") },
			
			{ ItemType.Bint, 678958360 },
			{ ItemType.Aptechka, 678958360 },
			{ ItemType.Tabletka, 678958360 },
			{ ItemType.Adrenalin, 678958360 },

            { ItemType.Kokos, NAPI.Util.GetHashKey("p_a4_sheets_s") },

            { ItemType.Gold, NAPI.Util.GetHashKey("prop_gold_bar") },
            { ItemType.Iron, NAPI.Util.GetHashKey("prop_ecola_can") },

            { ItemType.SnowBall, NAPI.Util.GetHashKey("w_ex_snowball") },

			{ ItemType.Potata, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.Morkov, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.Pshenica, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.Clever, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.Milk, NAPI.Util.GetHashKey("prop_cigar_pack_01") },

             { ItemType.SPotata, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.SMorkov, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.SPshenica, NAPI.Util.GetHashKey("prop_cigar_pack_01") },
             { ItemType.SClever, NAPI.Util.GetHashKey("prop_cigar_pack_01") },			
        };
        ...
        public static Dictionary<ItemType, Vector3> ItemsPosOffset = new Dictionary<ItemType, Vector3>()
        {
            ...
            { ItemType.Bag, new Vector3(0, 0, -0.85) },
			...
			{ ItemType.Vinograd, new Vector3(0, 0, -1) },
            { ItemType.Delivery, new Vector3(0, 0, -1) },
            ...
            /*Alco */
            { ItemType.MartiniAsti, new Vector3(0, 0, -0.99) },
			{ ItemType.Sambuca, new Vector3(0, 0, -0.99) },
			{ ItemType.VodkaWLimon, new Vector3(0, 0, -0.99) },
			{ ItemType.VodkaWBrusk, new Vector3(0, 0, -0.99) },
			{ ItemType.RussianStan, new Vector3(0, 0, -0.99) },
			{ ItemType.KoniakDjiva, new Vector3(0, 0, -0.99) },
			{ ItemType.KoniakApara, new Vector3(0, 0, -0.99) },
			{ ItemType.PivoRazliva, new Vector3(0, 0, -0.99) },
			{ ItemType.PivoButiloc, new Vector3(0, 0, -0.99) },
            { ItemType.Bong, new Vector3(0, 0, -0.99) },

			{ ItemType.Repair, new Vector3(0, 0, -0.99) },	

			{ ItemType.Bint, new Vector3(0, 0, -0.9) },
			{ ItemType.Aptechka, new Vector3(0, 0, -0.9) },
			{ ItemType.Tabletka, new Vector3(0, 0, -0.9) },
			{ ItemType.Adrenalin, new Vector3(0, 0, -0.9) },

            { ItemType.Kokos, new Vector3(0, 0, -0.9) },
			
			{ ItemType.Gold, new Vector3(0, 0, -0.9) },
			{ ItemType.Iron, new Vector3(0, 0, -0.9) },
			
			{ ItemType.SnowBall, new Vector3(0, 0, -0.9) },
			
			{ ItemType.Potata, new Vector3(0, 0, -0.95) },
            { ItemType.Morkov, new Vector3(0, 0, -0.95) },
            { ItemType.Pshenica, new Vector3(0, 0, -0.95) },
            { ItemType.Clever, new Vector3(0, 0, -0.95) },
            { ItemType.Milk, new Vector3(0, 0, -0.95) },

            { ItemType.SPotata, new Vector3(0, 0, -0.95) },
            { ItemType.SMorkov, new Vector3(0, 0, -0.95) },
            { ItemType.SPshenica, new Vector3(0, 0, -0.95) },
            { ItemType.SClever, new Vector3(0, 0, -0.95) },
        };
        public static Dictionary<ItemType, Vector3> ItemsRotOffset = new Dictionary<ItemType, Vector3>()
        {
			...
			{ ItemType.Vinograd, new Vector3() },
            { ItemType.Delivery, new Vector3() },
			...
			/*Alco */
            { ItemType.MartiniAsti, new Vector3(90, 0, 0) },
			{ ItemType.Sambuca, new Vector3(0, 0, 0) },
			{ ItemType.VodkaWLimon, new Vector3(90, 0, 0) },
			{ ItemType.VodkaWBrusk, new Vector3(90, 0, 0) },
			{ ItemType.RussianStan, new Vector3(90, 0, 0) },
			{ ItemType.KoniakDjiva, new Vector3(90, 0, 0) },
			{ ItemType.KoniakApara, new Vector3(90, 0, 0) },
			{ ItemType.PivoRazliva, new Vector3(90, 0, 0) },
			{ ItemType.PivoButiloc, new Vector3(90, 0, 0) },
            { ItemType.Bong, new Vector3(90, 0, 0) },
			
			{ ItemType.Repair, new Vector3(0, 0, 0) },
			
			{ ItemType.Bint, new Vector3(0, 0, 0) },
			{ ItemType.Aptechka, new Vector3(0, 0, 0) },
			{ ItemType.Tabletka, new Vector3(0, 0, 0) },
			{ ItemType.Adrenalin, new Vector3(0, 0, 0) },

            { ItemType.Kokos, new Vector3(0, 0, 0) },
			 
			{ ItemType.Gold, new Vector3(0, 0, 0) },
			{ ItemType.Iron, new Vector3(0, 0, 0) },
			
			{ ItemType.SnowBall, new Vector3(0, 0, 0) },
			
			{ ItemType.Potata, new Vector3(90, 90, 90) },
             { ItemType.Morkov, new Vector3(90, 90, 90) },
             { ItemType.Pshenica, new Vector3(90, 90, 90) },
             { ItemType.Clever, new Vector3(90, 90, 90) },
             { ItemType.Milk, new Vector3(90, 90, 90) },

             { ItemType.SPotata, new Vector3(90, 90, 0) },
             { ItemType.SMorkov, new Vector3(90, 90, 0) },
             { ItemType.SPshenica, new Vector3(90, 90, 0) },
             { ItemType.SClever, new Vector3(90, 90, 0) },
        };
        ...
        public static Dictionary<ItemType, int> ItemsStacks = new Dictionary<ItemType, int>()
        {
            ...
            { ItemType.Present, 1 },
            { ItemType.KeyRing, 5 },
			{ ItemType.Vinograd, 50 },
            { ItemType.Delivery, 10 },
			...
			/*Alco */
            { ItemType.MartiniAsti, 5 },
			{ ItemType.Sambuca, 5 },
			{ ItemType.VodkaWLimon, 5 },
			{ ItemType.VodkaWBrusk, 5 },
			{ ItemType.RussianStan, 5 },
			{ ItemType.KoniakDjiva, 5 },
			{ ItemType.KoniakApara, 5 },
			{ ItemType.PivoRazliva, 5 },
			{ ItemType.PivoButiloc, 5 },
            { ItemType.Bong, 1 },
			...
			{ ItemType.Bint, 10 },
			{ ItemType.Aptechka, 10 },
			{ ItemType.Tabletka, 5 },
			{ ItemType.Adrenalin, 5 },
			...
			{ ItemType.Potata, 25 },
            { ItemType.Morkov, 25 },
            { ItemType.Pshenica, 25 },
            { ItemType.Clever, 15 },
            { ItemType.Milk, 5 },

            { ItemType.SPotata, 20 },
            { ItemType.SMorkov, 20 },
            { ItemType.SPshenica, 20 },
            { ItemType.SClever, 15 },
		...
		return;
                            ...
                            else
                            {
                                ...
                                switch (Main.Players[player].FractionID)
                                {
									...
									case 13:
                                        ...
                                        break;											
								    case 14:
                                        Customization.CustomPlayerData[Main.Players[player].UUID].Clothes.Bodyarmor.Texture = 3; // Army
									...
									case 17:
                                        ...
                                        break;
									case 18:
                                        Customization.CustomPlayerData[Main.Players[player].UUID].Clothes.Bodyarmor.Texture = 7; // Групп6
										Customization.CustomPlayerData[Main.Players[player].UUID].Clothes.Bodyarmor.Variation = 28;
                    ...
                    case ItemType.Top:
                        ...
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            ...
                            Commands.RPChat("me", player, $"выпил(а) Martini Asti");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.MartiniAsti], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                                {
                                    if (player != null)
                                    {
                                        ...
                                        Main.OffAntiAnim(player);
                                        BasicSync.DetachObject(player);
                                        Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 150000, false);
                                    }
                                }
                                catch { }
                            }, 5000);
                        ...
                        break;
					case ItemType.Sambuca:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Sambuca");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.Sambuca], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.VodkaWLimon:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Водка с лимоном");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.VodkaWLimon], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.VodkaWBrusk:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Водка с брусникой");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.VodkaWBrusk], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.RussianStan:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Русский стандарт");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.RussianStan], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.KoniakDjiva:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Коньяк Дживан");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.KoniakDjiva], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.KoniakApara:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Коньяк Арарат");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.KoniakApara], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.PivoRazliva:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Пиво разливное");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.PivoRazliva], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
                        ...
                        break;
					case ItemType.PivoButiloc:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            EatManager.AddWater(player, 20);
                            player.Health = player.Health - 5;
                            Trigger.PlayerEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 300000, false);
                            Commands.RPChat("me", player, $"выпил(а) Пиво бутылочное");
                            player.SetData("USE_DRUGS", DateTime.Now.AddMinutes(3));

                            BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[ItemType.PivoButiloc], 57005, new Vector3(0.1, -0.08, -0.02), new Vector3(-90, 0, 0));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@world_human_drinking@beer@male@idle_a", "idle_c", 49);
                            NAPI.Task.Run(() => {
                                try
					...
					Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Используйте через [G]", 3000);
					return;	
					
					case ItemType.Potata:
    case ItemType.Morkov:
    case ItemType.Pshenica:
    case ItemType.Clever:
    case ItemType.Milk:
        return;
    case ItemType.SPotata:
        try
        {
            if (Jobs.FermaWork.FermaLeft == 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Поле нуждается в культивации", 3000);
                return;
            }
                            foreach (GTANetworkAPI.Object obj in Jobs.FermaWork.FermaObj)
                            {
                                if (obj.Position.DistanceTo2D(player.Position) < 1.5f)
                                {
                                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Рядом есть другие растения", 3000);
                                    return;
                                }
                            } 
                            if (player.HasData("CANPLANT"))
            {
                Jobs.FermaWork.PlantTree(player, 0);
                nInventory.Remove(player, new nItem(ItemType.SPotata, 1));
            }
            else
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы можете садить только на поле.", 3000);
                return;
            }
        }
        catch (Exception e) { Log.Write("EXCEPTION AT \"CMD\":\n" + e.ToString(), nLog.Type.Error); }
        return;
    case ItemType.SMorkov:
        try
        {
            if (Jobs.FermaWork.FermaLeft == 0)
            {
                ...
                return;
                            ...
                            if (player.HasData("CANPLANT"))
            {
                Jobs.FermaWork.PlantTree(player, 2);
                nInventory.Remove(player, new nItem(ItemType.SMorkov, 1));
            }
            else
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы можете садить только на поле.", 3000);
        ...
        try
        {
            if (Jobs.FermaWork.FermaLeft == 0)
            {
                ...
                return;
                            ...
                            if (player.HasData("CANPLANT"))
            {
                Jobs.FermaWork.PlantTree(player, 1);
                nInventory.Remove(player, new nItem(ItemType.SPshenica, 1));
            }
            else
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы можете садить только на поле.", 3000);
    ...
    case ItemType.SClever:
        try
        {
            if (Jobs.FermaWork.FermaLeft == 0)
            {
                ...
                return;
                            ...
                            if (player.HasData("CANPLANT"))
            {
                Jobs.FermaWork.PlantTree(player, 3);
                nInventory.Remove(player, new nItem(ItemType.SClever, 1));
            }
            else
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы можете садить только на поле.", 3000);
        ...
        return;
                    ...
                    case ItemType.Material:
                        Trigger.PlayerEvent(player, "board", "close");
                    ...
                    case ItemType.GasCan:
                        ...
                        if (player.Vehicle.HasData("ACCESS") && player.Vehicle.GetData<string>("ACCESS") == "GARAGE" || player.Vehicle.HasData("ACCESS") && player.Vehicle.GetData<string>("ACCESS") == "GARAGEORG")
                        {
                    ...
                    case ItemType.HealthKit:
                        ...
                        break;
					case ItemType.Vinograd:
                        if (!player.HasData("USE_VIN") || DateTime.Now > player.GetData<DateTime>("USE_VIN"))
                        {
                            ...
                            player.SetData("USE_VIN", DateTime.Now.AddSeconds(3));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@code_human_wander_eating_donut_fat@male@base", "static", 15);
                            BasicSync.AttachObjectToPlayer(player, NAPI.Util.GetHashKey("prop_food_cb_bag_01"), 6286, new Vector3(0.11, 0.03, -0.01), new Vector3(85, -15, 120));
                            NAPI.Task.Run(() => {
                            try
                            {
                    ...
                    case ItemType.Delivery:
                        if (!player.HasData("USE_VIN") || DateTime.Now > player.GetData<DateTime>("USE_VIN"))
                        {
                            ...
                            EatManager.AddEat(player, -10);
                            player.Health = (player.Health + 1 > 100) ? 100 : player.Health + 1;
                            Trigger.PlayerEvent(player, "stopScreenEffect", "PPFilter");
                            player.SetData("USE_VIN", DateTime.Now.AddSeconds(3));
                            Main.OnAntiAnim(player);
                            player.PlayAnimation("amb@code_human_wander_eating_donut_fat@male@base", "static", 15);
                            BasicSync.AttachObjectToPlayer(player, NAPI.Util.GetHashKey("ng_proc_food_ornge1a"), 6286, new Vector3(0.11, 0.03, -0.01), new Vector3(85, -15, 120));
                            NAPI.Task.Run(() => {
                                try
                                {
                                    if (player == null) return;
                    ...
                    case ItemType.Bint:
                        ...
                        {
                            player.Health = (player.Health + 5> 100) ? 100 : player.Health + 5;
                            player.SetData("USE_MEDKIT", DateTime.Now.AddMinutes(0));
					...
					case ItemType.Tabletka:
                        if (!player.HasData("USE_MEDKIT") || DateTime.Now > player.GetData<DateTime>("USE_MEDKIT"))
                        {
                            ...
                            player.SetData("USE_MEDKIT", DateTime.Now.AddMinutes(0));
                            Commands.RPChat("me", player, $"принял(а) таблетку");
                            if (!player.IsInVehicle)
                            {
                                Main.OnAntiAnim(player);
                                player.PlayAnimation("amb@code_human_wander_texting_fat@female@enter", "enter", 49);
					...
					case ItemType.Adrenalin:
                        if (!player.HasData("USE_MEDKIT") || DateTime.Now > player.GetData<DateTime>("USE_MEDKIT"))
                        {
                            ...
                            player.SetData("USE_MEDKIT", DateTime.Now.AddMinutes(0));
                            Commands.RPChat("me", player, $"использовал(а) укол адреналина");
                            NAPI.Task.Run(() => { try { if (player != null) { if (!player.IsInVehicle) { player.StopAnimation(); Main.OffAntiAnim(player); Main.OffAntiAnim(player); } } } catch { } }, 1000);
                        }
                        else
                        {
                    ...
                    case ItemType.Lockpick:
                        ...
                        Trigger.PlayerEvent(player, "showLoader", "Идёт взлом", 1);
        ...
        public static void onDrop(Player player, nItem item, dynamic data)
        {
            try
            {
                ...
                obj.SetData("DELETETIMER", Timers.StartOnce(1800000, () => deleteObject(obj)));
            }
