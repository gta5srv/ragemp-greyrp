    ...
    class Cityhall : Script
    {
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Крафт оружия"), new Vector3(CityhallChecksCoords[0].X, CityhallChecksCoords[0].Y, CityhallChecksCoords[0].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Переодевалка"), new Vector3(CityhallChecksCoords[1].X, CityhallChecksCoords[1].Y, CityhallChecksCoords[1].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
                ...
                for (int i = 2; i < 4; i++)
                {
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Нажмите Е"), new Vector3(CityhallChecksCoords[i].X, CityhallChecksCoords[i].Y, CityhallChecksCoords[i].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Склад оружия"), new Vector3(CityhallChecksCoords[6].X, CityhallChecksCoords[6].Y, CityhallChecksCoords[6].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
        ...
        {
            new Vector3(-534.6371, -176.374, 42.363914), // оружейка в мэрии 0z
            new Vector3(-535.70654, -174.4475, 42.363914), // раздевалка в мэрии
            new Vector3(-545.0524, -204.0801, 20.09514), // main door enter
            new Vector3(233.312, 216.0169, 20.1667), // main door exit
            new Vector3(256.9124, 220.4567, 105.2864), // door 1
            new Vector3(265.8495, 218.1592, 109.283), // door 2
            new Vector3(-529.08264, -171.91936, 42.36392), // gun stock 6
