...
namespace UnitedRP.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                //NAPI.Blip.CreateBlip(589, Merryweather.Coords[0], 0.7f, 75, Main.StringToU16("Меривейзер"), 255, 0, true, 0, 0);
                //NAPI.Blip.CreateBlip(207, Manager.FractionSpawns[16], 0.7f, 73, Main.StringToU16("Казино"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(590, LSNews.LSNewsCoords[0], 1, 45, Main.StringToU16("Новостное Агенство"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallChecksCoords[2], 1.1f, 4, Main.StringToU16("Правительство"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(60, Police.policeCheckpoints[1], 1, 38, Main.StringToU16("Полиция"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(85, Army.ArmyCheckpoints[2], 1, 28, Main.StringToU16("Армия"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(567, Manager.FractionSpawns[10], 1, 47, Main.StringToU16("ЧОО"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[11], 1, 4, Main.StringToU16("Русская Мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[12], 1, 76, Main.StringToU16("Мексиканская Мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[13], 1, 5, Main.StringToU16("Итальянское Посольство"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(621, Manager.FractionSpawns[67], 1, 1, Main.StringToU16("Церковь"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(50, new Vector3(904.9575, -2926.302, 4.780589), 1, 6, Main.StringToU16("Контейнеры"), 255, 0, true, 0, 0);

                //NAPI.Blip.CreateBlip(487, NacBez.CoordsNac[0], 1, 30, Main.StringToU16("Gruppe 6"), 255, 0, true, 0, 0);

                var shape = NAPI.ColShape.CreateCylinderColShape(new Vector3(359.77145, -585.01654, 27.69834), 3f, 3, 0);
                var shape2 = NAPI.ColShape.CreateCylinderColShape(new Vector3(355.5426, -595.9737, 27.65402), 3f, 3, 0);
                var shape3 = NAPI.ColShape.CreateCylinderColShape(new Vector3(297.90366, -584.11224, 42.122063), 3f, 3, 0);
                var shape4 = NAPI.ColShape.CreateCylinderColShape(new Vector3(319.09128, -559.2485, 27.623772), 3f, 3, 0);
                var shape5 = NAPI.ColShape.CreateCylinderColShape(new Vector3(327.62537, -559.3047, 27.623772), 6f, 3, 0);
                var shape6 = NAPI.ColShape.CreateCylinderColShape(new Vector3(339.7418, -564.4038, 27.623802), 6f, 3, 0);
        ...
        {
            {1, new Vector3(-136.9454, -1591.8394, 34.350803)},    // The Families
            {2, new Vector3(108.75756, -1955.1771, 20.360931)},     // The Ballas Gang
            {3, new Vector3(1435.1777, -1496.8877, 62.253807)},     // Los Santos Vagos
            {4, new Vector3(477.9176, -1889.4242, 25.391754)},     // Marabunta Grande
            {5, new Vector3(967.5901, -1831.698, 30.2642)},     // Blood Street
            {6, new Vector3(360.3282, -1421.194, 31.4)},      // Cityhall
            {7, new Vector3(456.7895, -990.8587, 30.56958)},      // LSPD police
            {8, new Vector3(296.04504, -580.946, 43.16986)},      // Emergency care
            {9, new Vector3(149.4746, -756.9065, 243.0319)},     // FBI 
            {10, new Vector3(1398.391, 1140.743, 113.3335)},     // La Cosa Nostra 
            ...
            {14, new Vector3(-2340.7263, 3265.1267, 32.707647)},    // Army
            {15, new Vector3(-1046.083, -226.20459, 38.593284)},    // LSNews
    ...
    class Stocks : Script
    {
        ...
        {
            { 1, new Vector3(-136.48682, -1608.6522, 33.91018)},
            { 2, new Vector3(108.004486, -1980.0034, 19.842598)},
            { 3, new Vector3(1436.6919, -1489.2156, 65.49932)},
            { 4, new Vector3(476.25787, -1900.2363, 24.837708)},
            { 5, new Vector3(973.2294, -1844.04, 25.4073)},
            { 6, new Vector3()},
            { 7, new Vector3()},
            { 8, new Vector3()},
            { 9, new Vector3()},
            { 10, new Vector3(1402.252, 1139.533, 108.7456)},
            { 11, new Vector3(-97.25447, 987.44916, -234.63676)}, // 234.63676
        ...
        {
            { 1, new Vector3(-126.5523, -1620.4062, 30.87895)},
            { 2, new Vector3(88.592026, -1968.2312, 19.607937)},
            { 3, new Vector3(1422.625, -1502.5981, 59.637573)},
            { 4, new Vector3(457.333, -1883.4205, 25.071196)},
            ...
            { 11, new Vector3(-128.7453, 1006.892, -235.6121)}, //235.6121
        ...
        public void fillStocks()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    {
                        data.label = NAPI.TextLabel.CreateTextLabel("~w~", garageCoords[id] + new Vector3(0, 0, 1.5), 10f, 0.4f, 0, new Color(255, 255, 255), true);
                    ...
                    NAPI.Marker.CreateMarker(1, stockCoords[id] - new Vector3(0, 0, 0.3), new Vector3(), new Vector3(), 1f, new Color(153, 153, 255, 255));
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~w~Склад {Manager.getName(id)}"), new Vector3(stockCoords[id].X, stockCoords[id].Y, stockCoords[id].Z + 0.6), 5F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.Marker.CreateMarker(1, garageCoords[id], new Vector3(), new Vector3(), 3f, new Color(255, 255, 255));
                    NAPI.Marker.CreateMarker(30, garageCoords[id], new Vector3(0, 0, 0.5), new Vector3(), 1f, new Color(153, 153, 255));
                }
            }
