...
namespace UnitedRP.Fractions
{
    class Gangs : Script
    {
        ...
        {
            { 1, new Vector3(-223.069, -1616.918, -133.74932) },
            { 2, new Vector3(85.79318, -1958.851, -120.0017) },
            { 3, new Vector3(1408.579, -1486.897, -159.53736) },
            { 4, new Vector3(892.2407, -2172.888, -131.16626) },
            { 5, new Vector3(485.3334, -1528.692, -128.18008) },
        };
        ...
        {
            //new Vector3(8.621573, 3701.914, -139.51624),
            //new Vector3(3804.169, 4444.753, -103.977164),
        };
        private static int PricePerDrug = 5;
        ...
        public void Event_OnResourceStart()
        {
            try
            {
                ...
                foreach (var pos in DrugPoints)
                {
                    ...
                    NAPI.TextLabel.CreateTextLabel($"~b~Купить наркотики ({PricePerDrug}$/грамм)", pos + new Vector3(0, 0, 0.7), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                    NAPI.Blip.CreateBlip(140, pos, 0.5f, 4, "Наркотики", 255, 0, true, 0, 0);
        ...
        public static void InteractPressed(Player player)
        {
            ...
            Trigger.PlayerEvent(player, "openInput", "Закупить наркотики", $"Введите кол-во:", 4, "buy_drugs");
        }
