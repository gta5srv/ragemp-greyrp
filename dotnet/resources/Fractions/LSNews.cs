...
namespace UnitedRP.Fractions
{
    class LSNews : Script
    {
        ...
        {
            new Vector3(-1052.1909, -232.45207, 42.9009), // Метка над новостями - блип
            new Vector3(-1052.1909, -232.45207, 42.9009), // Колшэйп изнутри интерьера для телепорта наверх
        };
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Переодеться"), LSNewsCoords[1] + new Vector3(0, 0, 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));

                NAPI.Marker.CreateMarker(1, LSNewsCoords[0] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, LSNewsCoords[1] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(153, 153, 255, 255));
            }
            catch (Exception e)
            {
