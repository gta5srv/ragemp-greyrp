    ...
    class Gopostal : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Взять посылки"), Coords[0] + new Vector3(0, 0, 0.3), 10F, 0.6F, 0, new Color(0, 180, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Взять рабочий транспорт"), Coords[1] + new Vector3(0, 0, 0.3), 10F, 0.6F, 0, new Color(0, 180, 0));
            ...
            try
            {
                ...
                if (player.HasData("NEXTHOUSE") && player.HasData("HOUSEID") && NAPI.Data.GetEntityData(player, "NEXTHOUSE") == player.GetData<int>("HOUSEID"))
                {
                    ...
                    else if (player.GetData<int>("PACKAGES") > 1)
                    {
                        ...
                        var coef = Convert.ToInt32(player.Position.DistanceTo2D(player.GetData<Vector3>("W_LASTPOS")) / (100 - Main.AddJobPoint(player) * 5));
                        ...
                        //GameLog.Money($"server", $"player({Main.Players[player].UUID})", payment + level, $"postalCheck");
                        ...
                        Trigger.PlayerEvent(player, "createCheckpoint", 1, 1, HouseManager.Houses[next].Position, 1, 0, 255, 0, 0);
                    ...
                    else
                    {
                        ...
                        Trigger.PlayerEvent(player, "createWaypoint", 105.4633f, -1568.843f);
