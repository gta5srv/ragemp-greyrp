...
const houseClasses = [
  hclass(1, "Трейлер", "Нищебродские дома", 1),
  hclass(2, "Эконом", "Нищебродские дома", 1),
  hclass(3, "Econom+", "Ну, так себе", 2),
  hclass(4, "Comfort", "Уже неплохо", 4),
  hclass(5, "Comfort+", "А ты двигаешься", 5),
  hclass(6, "Premium", "Ого, ничего себе", 6),
  hclass(7, "Premium+", "Я еле сдерживаю эмоции", 8),
]
