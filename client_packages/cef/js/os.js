    ...
    json.forEach(function (item, i, arr) {
        switch (item[2]) {
			...
			case 21:
                ...
                break;	
			case 22:
				addgBtn(item[0], i, item[1], item[4], item[5]);
				break;
			case 23:
				iconBtn(item[0], i, item[1], item[4], item[5],"mailBtn");
				break;
			case 24:
				iconBtn(item[0], i, item[1], item[4], item[5],"strafBtn");
				break;
			case 25:
				iconBtn(item[0], i, item[1], item[4], item[5],"radioBtn");
				break;
			case 26:
				iconBtn(item[0], i, item[1], item[4], item[5],"airBtn");
				break;
        }
        IND++;
    });
...
function addgBtn(id, index, title, col, big,btnType) {
    var callback = "call('" + id + "','button');";
    var pure = "pure-u-";
    var style = "gbutton";
    if (col === 1) pure = pure + col;
